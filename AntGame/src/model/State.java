...
class Flip extends State{
	...
	/**
	 * A simple constructor.
	 * @param value The generated random number will be between 0 (inclusive) and this value (exclusive). 
	 * @param state1 The state to go to if the random value is equal to 0.
	 * @param state2 The state to go to otherwise.
	 */
