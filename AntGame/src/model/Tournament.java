...
/**
 * A tournament class that manages the matches between a group of players and a group of worlds so that there is two matches (swapping teams after the first) on
 * each world with every possible pair of players.
 * 
 * @author 108069
 * 
 */
