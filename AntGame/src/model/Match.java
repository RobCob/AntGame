...
public class Match {
	...
	/**
	 * This class simply holds the three components required for a match to be played. 2 AntBrain objects (1 for each Player) and a World object for the Match
	 * to be played on.
	 * 
	 * @param player1
	 * @param player2
	...
	/**
	 * Progresses the match by a single round, this consists of: Instructing each ant (in ascending ID order) to simulate, either resting or executing a state
	 * from their brain. If it is the last round, calculate match scores and set the winner.
	 */
	 ...
	 * 
	 * @param player
	 *            The player whose score to check.
	 * @param i
	 *            The index of the required score.
	 ...
	 * 
	 * @param player
	 *            The player whose food score is wanted.
	 ...
	 * 
	 * @param player
	 *            The player whose alive Ant count is wanted.
	 ...
	 * 
	 * @param player
	 *            The player whose dead Ant count is wanted.
	 ...
	 * 
	 * @return Will return null until the last round has passed. If the match is a draw (both player's food scores are the same), winner will remain equal to
	 *         null.
	 */
