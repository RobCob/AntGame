...
public class HexGrid extends JPanel {
	 ...
	 * @param strokeWidth
	 *            the width of the stroke for each hexagon.
	 */
	 ...
	 * 
	 * @param x
	 *            the x position for the Hexagon (column).
	 * @param y
	 *            the y position for the Hexagon (row).
	 * @param h
	 *            the hexagon to assign.
	 */
	 ...
	 * 
	 * @param x
	 *            the x position of the Hexagon.
	 * @param y
	 *            the y position of the Hexagon.
	 ...
	 * 
	 * @param size
	 *            the new size of each of the hexagons.
	 */
	 ...
	 * 
	 * @param width
	 *            width of the HexGrid panel.
	 * @param height
	 *            height of the HexGrid panel.
	 */
	 ...
	 * 
	 * @param hexagons
	 *            a 2D array of Hexagons ([column][row])
	 */
