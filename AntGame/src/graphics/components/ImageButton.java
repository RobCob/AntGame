...
/**
 * ImageButton: A JPanel that simulates a button. The button has two states, hovered and not-hovered. When hovered the button will display the BufferedImage
...
public abstract class ImageButton extends JPanel implements MouseListener {
	 ...
	 *            the background of the button when not hovered.
	 * @param hoverImage
	 *            the background of the button when the mouse is hovering over it.
	 */
	...
	/**
	 * Change the background image to the hover image specified. Change the pointer to the 'hand' pointer.
	 */
