...
/**
 * CustomWorldSelectionPanel: A screen for the AntGame. This screen allows players to create a world (by setting various parameters) to play their match on.
 * 
 * @author 105957
 * @author 109195
 */
public class WorldEditorPanel extends JPanel implements Screen {

	private static final long serialVersionUID = 43600297951925383L;
	private static final BufferedImage PLUS_IMAGE = ImageLoader.loadImage("/WorldEditorPanelImages/plusButton.png");
	private static final BufferedImage PLUS_HOVER_IMAGE = ImageLoader.loadImage("/WorldEditorPanelImages/plusButtonHover.png");
	private static final BufferedImage MINUS_IMAGE = ImageLoader.loadImage("/WorldEditorPanelImages/minusButton.png");
	private static final BufferedImage MINUS_HOVER_IMAGE = ImageLoader.loadImage("/WorldEditorPanelImages/minusButtonHover.png");
	private static final BufferedImage ROCKS_IMAGE = ImageLoader.loadImage("/WorldEditorPanelImages/numberOfRocks.png");
	private static final BufferedImage FOOD_IMAGE = ImageLoader.loadImage("/WorldEditorPanelImages/amountOfFood.png");
	private static final BufferedImage ANTHILL_IMAGE = ImageLoader.loadImage("/WorldEditorPanelImages/sizeOfAnthill.png");
	private static final BufferedImage CREATE_BUTTON = ImageLoader.loadImage("/WorldEditorPanelImages/createButton.png");
	private static final BufferedImage CREATE_HOVER_BUTTON = ImageLoader.loadImage("/WorldEditorPanelImages/createButtonHover.png");
	...
	private static final BufferedImage WORLD_EDITOR_IMAGE = ImageLoader.loadImage("/WorldEditorPanelImages/worldDimensions.png");
	private static final BufferedImage BACKGROUND_IMAGE = ImageLoader.loadImage("/GlobalImages/background.jpg");
	private static final BufferedImage TITLE_IMAGE = ImageLoader.loadImage("/WorldEditorPanelImages/worldEditorTitle.png");
	...
	/**
	 * Constructor: Initialises the screen that allows players to create a world to play their match on.
	 * 
	 * @param game
	 *            the ant-game controller that this screen is a part of.
	 * @param parentpanel
	 *            the SingleMatchWorldPanel that will open this screen.
	 */
	public WorldEditorPanel(Game game, SingleMatchWorldPanel parentPanel) {
		...
		ImageButton rocksMinusButton = new ImageButton(MINUS_IMAGE, MINUS_HOVER_IMAGE) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2405900712128393488L;
		...
		ImageButton rocksPlusButton = new ImageButton(PLUS_IMAGE, PLUS_HOVER_IMAGE) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -8699932083834329671L;
		...
		ImageButton foodMinusButton = new ImageButton(MINUS_IMAGE, MINUS_HOVER_IMAGE) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -5730357527553033966L;
		...
		ImageButton foodPlusButton = new ImageButton(PLUS_IMAGE, PLUS_HOVER_IMAGE) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2788461467100514527L;
		...
		ImageButton sizeOfAnthillMinusButton = new ImageButton(MINUS_IMAGE, MINUS_HOVER_IMAGE) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -8072854476979287056L;
		...
		ImageButton sizeOfAnthillPlusButton = new ImageButton(PLUS_IMAGE, PLUS_HOVER_IMAGE) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -5180080216331064704L;
		...
		ImageButton createButton = new ImageButton(CREATE_BUTTON, CREATE_HOVER_BUTTON) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 2230806447829776670L;

			public void mouseClicked(MouseEvent e) {
				String errorMessage = getErrorMessage();
				boolean valid = errorMessage == null;
				if (!valid) {
					JOptionPane.showMessageDialog(WorldEditorPanel.this, errorMessage, "Error", JOptionPane.ERROR_MESSAGE);
				} else {
					...
					World antWorld = World.generateWorld(Integer.parseInt(firstDimension.getText()), Integer.parseInt(secondDimension.getText()), antHillSize,
							rockCount, foodPileCount);
		...
		ImageButton backButton = new ImageButton(BACK_BUTTON, BACK_HOVER_BUTTON) {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 595291839289661631L;
