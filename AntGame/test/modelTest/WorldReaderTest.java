...
public class WorldReaderTest {
	...
	public void validReadTest1() {
		...
		oracle[1][2] = new ClearTile(1);
		oracle[3][2] = new ClearTile(2);
	...
	public void validReadTest2() {
		...
		assertNotNull("Loading a correct world should not return null: ", readWorld);
	}
	...
	public void validReadTest7() {
		...
		assertNull("Test should fail when a cell is a character: ", readWorld);
	}

	@Test
	public void validReadTest8() {
		World readWorld = WorldReader.readWorld("assWorldTest7.world");
		assertNull("Test should fail when there is a gap in the north wall: ", readWorld);
	}

	@Test
	public void validReadTest9() {
		World readWorld = WorldReader.readWorld("assWorldTest8.world");
		assertNull("Test should fail when there is a gap in the south wall: ", readWorld);
	}
	@Test
	public void validReadTest10() {
		World readWorld = WorldReader.readWorld("assWorldTest9.world");
	...
	public void validReadTes11() {
		...
		assertNull("Test should fail when there is a gap in the west wall: ", readWorld);
	}
